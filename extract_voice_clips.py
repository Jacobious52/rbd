...
# Config
video_path = Path("/Volumes/surveillance/Bedroom Camera/20250605PM/Bedroom Camera-20250605-214810-1749124090161-7.mp4")
...
print(f"Detected {len(speech_timestamps)} speech segments: {speech_timestamps}")
...
for i, ts in enumerate(merged_timestamps):
    ...
    print(f"  -> Processing clip {i+1}/{len(merged_timestamps)}: start={start:.2f}s, duration={duration:.2f}s")
